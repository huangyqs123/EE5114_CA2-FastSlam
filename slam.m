...
for i = 1:size(output_temp,1)
	...
	for j = 1:particles_count		
        ...
        % Noise for translation and rotation
        theta_noise = motion_estimate(i).theta * (1 + theta_noise_proportion * randn(1)) + theta_noise_add * randn(1);
        x_noise = motion_estimate(i).x * (1 + translation_noise_proportion * randn(1)) + translation_noise_add * randn(1);
        y_noise = motion_estimate(i).y * (1 + translation_noise_proportion * randn(1)) + translation_noise_add * randn(1);
