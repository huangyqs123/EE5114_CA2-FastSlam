...
% Updates means, covariance for map features and update particle weight 
    ...
    known_corner.x = known_corner.x + K(1) * innovation(1);
    known_corner.y = known_corner.y + K(2) * innovation(2);
    known_corner.heading = slam_in_pi(known_corner.heading + K(3) * innovation(3));
    known_corner.angle = slam_in_pi(known_corner.angle + K(4) * innovation(4));
